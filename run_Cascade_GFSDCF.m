function results = run_Cascade_GFSDCF_n4(seq, res_path, bSaveImage, parameters)
...
fprintf('running Cascade_GFSDCF_n4...\n');

addpath(genpath('./scale'));
addpath(genpath('./tracker_exter'));
addpath(genpath('./tracker_featu'));
addpath(genpath('./tracker_imple'));
addpath(genpath('./tracker_utils'));
