...
%base_path='C:\PTB-TIR_Evaluation_toolkit\trackers\Cascade_GFSDCF_n4\'; 
base_path='C:\PTB-TIR_Evaluation_toolkit\';     
for i=1:numel(seq.s_frames)
     seq.s_frames1{i,1}=[base_path seq.s_frames{i,1}];%img_files_fullpath??§Ò?¡¤?
end
    
    seq.image_files =  seq.s_frames1;
%     seq.s_frames = seq.s_frames;
    seq = rmfield(seq, 's_frames');
    seq = rmfield(seq, 's_frames1');
